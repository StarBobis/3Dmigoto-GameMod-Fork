...
void ParseHuntingSection()
{
	...
	//Nico: 为了防止别人F8 dump你的Mod，直接把Hunting写死等于0
	G->hunting = 2;
	...
	//Nico:这里我们不读取ini，直接设置为F10
	G->config_reloadable = RegisterIniKeyBindingDIY(L"Hunting", L"reload_config", FlagConfigReload, NULL, noRepeat, NULL,L"VK_F10");
	...
	RegisterIniKeyBindingDIY(L"Hunting", L"monitor_performance", AnalysePerf, NULL, noRepeat, NULL, L"ctrl no_shift no_alt F9");
	...
	//Nico: 这里手动注册F10 但是要搞清楚格式
	RegisterIniKeyBindingDIY(L"Hunting", L"reload_fixes", ReloadFixes, NULL, noRepeat, NULL, L"F10");
